      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <div>
            ...
            >
              K-POP 찐팬을 위한 공정 티켓팅 플랫폼. 팬 신뢰 점수 기반 우선 예매와 에스크로 보호 양도 마켓.
            </p>
              ...
              <div className="flex flex-col gap-2.5">
                {col.links.map((link) => (
                  <Link
                    ...
                    style={{ fontSize: "0.78rem", color: "#4b5e78", fontWeight: 300 }}
                    onMouseEnter={(e) => (e.currentTarget.style.color = "#94a3b8")}
                    onMouseLeave={(e) => (e.currentTarget.style.color = "#4b5e78")}
                  >
                    {link.label}
                  </Link>
                ))}
        ...
        <div
          ...
          style={{ borderTop: "1px solid rgba(255,94,50,0.06)", fontSize: "0.72rem", color: "#4b5e78", fontWeight: 300 }}
        >
          <span>© 2026 URR. All rights reserved.</span>
          <div className="flex gap-6">
            <Link href="#" style={{ color: "#4b5e78" }}>개인정보처리방침</Link>
            <Link href="#" style={{ color: "#4b5e78" }}>이용약관</Link>
          </div>
        </div>
      </div>
    </footer>
