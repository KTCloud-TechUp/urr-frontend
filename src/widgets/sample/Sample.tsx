          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-8">
              ...
              <nav className="hidden md:flex gap-6">
                <a href="#" className="typography-body text-gray-700 hover:text-brand-600 transition-colors">
                  공연
                </a>
                <a href="#" className="typography-body text-gray-700 hover:text-brand-600 transition-colors">
                  티켓오픈
      ...
      <section className="bg-gradient-to-r from-brand-600 to-brand-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h2 className="typography-header mb-4">
              당신의 순간을 예매하세요
            </h2>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <div>
                      <span className="typography-label text-gray-500 block">시작가</span>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              { title: '[필독] 티켓 예매 시 주의사항 안내', date: '2026.02.01', badge: '중요' },
              { title: '2월 오픈 예정 공연 안내', date: '2026.02.02', badge: null },
              { title: '모바일 앱 업데이트 공지', date: '2026.01.30', badge: null },
              { title: '설 연휴 고객센터 운영 안내', date: '2026.01.28', badge: null }
            ].map((notice, index) => (
              <div
                key={index}
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h4 className="typography-subheader text-white mb-4">우르르 URR</h4>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="typography-body hover:text-white transition-colors">공지사항</a></li>
                <li><a href="#" className="typography-body hover:text-white transition-colors">자주 묻는 질문</a></li>
                <li><a href="#" className="typography-body hover:text-white transition-colors">1:1 문의</a></li>
              </ul>
            </div>
            <div>
              <h5 className="typography-body-bold text-white mb-3">회사 정보</h5>
              <ul className="space-y-2">
                <li><a href="#" className="typography-body hover:text-white transition-colors">회사소개</a></li>
                <li><a href="#" className="typography-body hover:text-white transition-colors">이용약관</a></li>
                <li><a href="#" className="typography-body hover:text-white transition-colors">개인정보처리방침</a></li>
              </ul>
            </div>
            <div>
