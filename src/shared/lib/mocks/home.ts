...
export const artistGradients: Record<string, string> = {
  ...
  "12": "linear-gradient(135deg, #8B4513 0%, #D2691E 50%, #8B4513 100%)",  // Bruno Mars
  ...
  "18": "linear-gradient(135deg, #264653 0%, #2a9d8f 50%, #264653 100%)",  // 투어스
};
...
export const featuredArtists: FeaturedArtist[] = [
  { id: "13", name: "악동뮤지션", image: "/recommend/recommend_akmu.png",            followerCount: 1420000, category: "group" },
  { id: "14", name: "권정렬",     image: "/recommend/recommend_kwon-jungyeol.png",   followerCount: 1420000, category: "solo"  },
  { id: "15", name: "RIIZE",      image: "/recommend/recommend_riize.png",           followerCount: 1420000, category: "new"   },
  { id: "16", name: "IU",         image: "/recommend/recommend_iu.png",              followerCount: 7800000, category: "solo"  },
  { id: "3",  name: "aespa",      image: "/recommend/recommend_aespa.png",           followerCount: 5500000, category: "group" },
  { id: "17", name: "NMIXX",      image: "/recommend/recommend_nmixx.png",           followerCount: 2800000, category: "group" },
  { id: "10", name: "TXT",        image: "/recommend/recommend_txt.png",             followerCount: 4300000, category: "group" },
  { id: "18", name: "투어스",     image: "/recommend/recommend_tours.png",           followerCount: 1200000, category: "new"   },
  { id: "8",  name: "NewJeans",   image: "/artists/artist_newjeans.png",             followerCount: 6100000, category: "new"   },
  { id: "6",  name: "Stray Kids", image: "/artists/artist_stray-kids.png",           followerCount: 5800000, category: "group" },
  { id: "7",  name: "SEVENTEEN",  image: "/artists/artist_seventeen.png",            followerCount: 5200000, category: "group" },
  { id: "9",  name: "(G)I-DLE",   image: "/artists/artist_gi-dle.png",               followerCount: 3900000, category: "group" },
];
