...
- Next.js 16, TypeScript strict, Tailwind CSS v4, shadcn/ui, TanStack Query v5, Zustand
...
```
idle → vqa (클라우드/미스트) 또는 queue (라이트닝/썬더 직행)
...
- 본인인증(CI 1인1계정) → 약관 동의 → **미스트 즉시 부여** → 아티스트 선택 → 멤버십 소개 → 멜론 연동(선택)
