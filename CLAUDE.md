...
| 등급        | 조건               | 예매 창       | 예매 수수료 | 양도 수수료 |
| ----------- | ------------------ | ------------- | ----------- | ----------- |
| 🌩️ 라이트닝 | 팬 신뢰 점수 ≥ 85  | 선예매 1순위  | +₩1,000     | 5%          |
| ⚡ 썬더     | 팬 신뢰 점수 66–84 | 2순위 (+1h)   | +₩2,000     | 5%          |
| ☁️ 클라우드 | 멤버십 가입 즉시   | 3순위 (+1day) | +₩3,000     | 10%         |
| 🌫️ 미스트   | 회원가입 즉시      | 일반예매만    | +₩4,000     | 양도불가    |
